...
?>
    <div class="border border-secondary-300 p-4 ">
        ...
        <form action="index.php?url=product/save/<?php echo $producto['id']; ?>" method="post" class='form'>
            <div class="form-group mb-3">
                <input type="hidden" name="id" value="<?php echo $producto['id']; ?>" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="suplidor" class='form-control' value="<?php echo $producto['suplidor']; ?>" required>
            </div>
            <div class="form-group mb-3">
                <label>Clave</label>
                <input type="password" name="clave" class='form-control'  placeholder="Nueva Contraseña" 
                    value="<?php echo $product['clave']; ?>" required>            
            </div>
            <div class="form-group mb-3">
